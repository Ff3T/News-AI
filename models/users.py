...
class User(Base):
    ...
    __table_args__ = (Index('username_UNIQUE','username'),
    ...
    avatar:Mapped[str]=mapped_column(String(255),comment="头像URL",default='https://fastly.jsdelivr.net/npm/@vant/assets/cat.jpeg')
...
class UserToken(Base):
    ...
    def __repr__(self):
        return f"<UserToken={self.token} user_id={self.user_id} token={self.token} >"